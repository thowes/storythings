  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved badge as @badge" do
        ...
        post :create, {:badge => { "name" => "invalid value" }}, valid_session
        assigns(:badge).should be_a_new(Badge)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested badge" do
        ...
        Badge.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => badge.to_param, :badge => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the badge as @badge" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Badge.any_instance.stub(:save).and_return(false)
        put :update, {:id => badge.to_param, :badge => { "name" => "invalid value" }}, valid_session
        assigns(:badge).should eq(badge)
      end
