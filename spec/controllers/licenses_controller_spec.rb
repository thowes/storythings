  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved license as @license" do
        ...
        post :create, {:license => { "name" => "invalid value" }}, valid_session
        assigns(:license).should be_a_new(License)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested license" do
        ...
        License.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => license.to_param, :license => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the license as @license" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        License.any_instance.stub(:save).and_return(false)
        put :update, {:id => license.to_param, :license => { "name" => "invalid value" }}, valid_session
        assigns(:license).should eq(license)
      end
